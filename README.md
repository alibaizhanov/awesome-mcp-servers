...
- **[Mengram](https://github.com/alibaizhanov/mengram)** - Multi-tenant memory layer for AI agents. Semantic, episodic, and procedural memory through one MCP server with 30 tools. 23 languages, multi-tenant by default, Apache 2.0.
